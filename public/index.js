import { passLength, alph, createCard } from "./shared.js";
...
function addHitsFromJson (json) {    
    ...
    for (let item in dataJson) {
        ...
        child.appendChild(createCard(dataJson[item].goodsName, dataJson[item].goodsGroup, dataJson[item].photo, 'Подробнее', ''))    
    }
